...
<t:pagetemplate>
    ...
    <jsp:body>
        ...
        <div class="container w-50 p-2 mt-4">
            <form action="signup" name="signup" onsubmit="return signupFinalCheck()" method="POST">
                <div class="mt-2">
                ...
                <div class="mt-2">
                    ...
                    <input type="email" class="form-control" id="repeatemail" name="repeatemail"
                ...
                <div class="form-row mt-2">
                    ...
                    <input type="text" class="form-control" id="address" name="address"
                           placeholder="Østerbrogade 4, 1. th.">
                </div>
                ...
                <button class="btn btn-primary col-3 float-center" type="submit" name="signupbtn" id="signupbtn">Opret
                    Bruger
                </button>
            </form>
        </div>
